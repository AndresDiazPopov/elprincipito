...
describe Users::LoginWithApiKey do

  subject { Users::LoginWithApiKey }
  ...
  context 'when a user exists' do
    ...
    describe 'call' do
      ...
      it 'raises Exceptions::NotFoundError when using an unexisting api_key' do
        expect{
          subject.call(
      ...
      it 'creates an denied login when using an unexisting api_key' do
        expect{
          subject.call(
            api_key: Faker::Internet.password(8),
            login_params: login_params,
